...
import { ROTULO_CURTO } from "../lib/papeis.mjs";
import logoMusa from "../assets/simbolo-musa.png";

/* Os rótulos moraram aqui até a M6.7. Saíram porque a tela de Usuários
 * precisava dos mesmos nomes, e duas listas divergem no primeiro papel novo —
 * foi o que aconteceu: a barra lateral nunca soube escrever "Secretária". */
const ROTULO_DO_PAPEL = ROTULO_CURTO;
