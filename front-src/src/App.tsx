...
/* A plataforma entra por `lazy` como as telas do CRM: quem visita o site da
 * clinica nao carrega um byte da administracao das 50. */
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* FORA de RotaProtegida de proposito: a plataforma tem sessao
            propria, e o guarda do CRM exige a do CRM. Quem cuida do acesso
            aqui e a propria tela, e o servidor. */}
