...
export default function ChatConsole({ 
  ...
  const handleCreateNewChat = async (e: React.FormEvent) => {
    ...
    try {
      ...
      /* Rota AUTENTICADA (11/09). Antes isto postava em `/api/leads`, que e a
       * porta PUBLICA do formulario do site -- funcionava so enquanto havia uma
       * clinica so, porque a rota publica sem chave de captacao respondia "a
       * unica que existe". Com a segunda clinica ela passou a recusar (503),
       * corretamente. Quem tem sessao entra pela porta de dentro: a clinica sai
       * do token, e nao de uma chave na URL. */
